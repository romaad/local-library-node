...
exports.bookinstance_create_post = function(req, res, next) {
	...
	if (errors) {
			...
			.exec(function (err, books) {
				if (err) { return next(err); }
				//Successful, so render
				res.render('bookinstance/bookinstance_form', { title: 'Create BookInstance', book_list : books, errors: errors, bookinstance:bookinstance });
			});
			return;
	} 
	else {
...
exports.bookinstance_delete_post = function(req, res, next) {
	req.checkBody('bookinstanceid', 'book instance id must be specified').notEmpty();
...
exports.bookinstance_update_get = function(req, res, next) {
	...
	async.parallel({
		...
		res.render('bookinstance/bookinstance_form',
		 {title: 'Update BookInstance', book_list:results.books, bookinstance: results.bookinstance});
	});
};
